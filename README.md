...
*   **Subredes:** El programa segmenta las llaves en dos tipos (o subredes) diferentes, dependiendo de su privilegio:
...
*   **Exportación:** Se permite exportar la configuración en tres maneras diferentes:
    - Un archivo `.conf`
    - Texto plano
...
Uno de los usos más atractivos es usar el modo servicio del programa.  
En este modo servicio es posible hacer consultas HTTP al programa en un puerto concreto para recibir datos y enviar comandos.  
Para activar el modo servicio solo es necesario especificar la flag `--server`, seguido del número del puerto, o en blanco para el puerto por defecto (9999) al ejecutar el programa.  
